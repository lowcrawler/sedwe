...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@usgs.gov";
    ...
    * @var string
    */
	// ORIG: protected $baseDn = "DC=mydomain,DC=local";
	protected $baseDn = "DC=gs;DC=doi;DC=net";
    ...
    * @var array
    */
    protected $domainControllers = array("igsdendc01.gs.doi.net", "igsresdc01.gs.doi.net");
